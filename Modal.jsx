...
export default function Modal({ open, onClose, title, children, footer, size = 'md' }) {
  useEffect(() => {
    ...
    // Hide the top header + bottom nav while the modal is open so the
    // form the user is filling is the only thing on screen (no clutter
    // peeking through the semi-transparent backdrop).
