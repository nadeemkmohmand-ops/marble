...
export default {
  // App identity
  appName: 'ماربل فیکٹری مینجمنٹ',
  appShortName: 'ماربل ایپ',
  factoryName: 'مہمند ماربل فیکٹری',
  tagline: 'فیکٹری مینجمنٹ سسٹم',
  location: 'مہمند، خیبر پختونخوا، پاکستان',
  version: 'ورژن 1.1.0',
  demoNote:
  ...
  about: {
    ...
    description1:
      'ماربل فیکٹری مینجمنٹ ایک موبائل ایپلیکیشن ہے جو خاص طور پر مہمند، پاکستان کی ماربل فیکٹریوں کی ضروریات کو مدنظر رکھ کر تیار کی گئی ہے۔ اس کی مدد سے فیکٹری کا پورا کام — سلیب کا حساب کتاب، ذخیرے کی نگرانی، اور روزانہ و ماہانہ رپورٹس — آپ کے موبائل پر ہی منظم ہو جاتا ہے۔',
    description2:
