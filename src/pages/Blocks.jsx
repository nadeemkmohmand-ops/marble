    ...
    <CrudPage
      config={{
        ...
        fields: [
          ...
          { key: 'cft', type: 'readonly', format: (v) => fmtNumber(v, 2), hint: t('hints.cftAuto') },
          { key: 'weightKg', type: 'readonly', format: (v) => fmtNumber(v, 0), hint: t('hints.weightAuto') },
          { key: 'density', type: 'number', hint: t('hints.densityDefault') },
          ...
          { key: 'landedTotal', type: 'readonly', format: (v) => fmtCurrency(v), hint: t('hints.landedTotalAuto') },
