    ...
    <CrudPage
      config={{
        ...
        fields: [
          ...
          { key: 'pieceCutting', type: 'number', min: 0, hint: t('hints.ratePerSqft') },
          { key: 'piecePolishing', type: 'number', min: 0, hint: t('hints.ratePerSqft') },
          { key: 'pieceLoading', type: 'number', min: 0, hint: t('hints.ratePerSlab') },
          { key: 'pieceInstallation', type: 'number', min: 0, hint: t('hints.ratePerOrder') },
          { key: 'advances', type: 'number', min: 0 },
          { key: 'loan', type: 'number', min: 0 },
          { key: 'loanInstallment', type: 'number', min: 0, hint: t('hints.monthlyRecovery') },
